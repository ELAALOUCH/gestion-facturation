...
<body class="bg-white">
                    ...
                    <div class="flex items-center lg:order-2 py-1.5">
                        ...
                        <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 " id="dropdown">
                            ...
                            <ul class="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                ...
                                <li>
                                    <a href="/company" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Paramètres</a>
                                </li>
                            </ul>
    ...
    @if (session()->has('status'))
        <div id="toast-success" class="z-10 mt-4 right-2 absolute flex items-center justify-end w-full max-w-xs p-4 mb-4 text-white bg-green-500 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
