                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-4 font-roboto">Code</th>
                                <th scope="col" class="px-4 py-3 font-roboto">catégorie</th>
                                <th scope="col" class="px-4 py-3 font-roboto">
                                <span class="sr-only font-roboto">Actions</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                             <td class="px-4 py-3">{{$categorie->id}}</td>
                                <td scope="row" class="px-4 py-3 font-roboto text-gray-900 whitespace-nowrap dark:text-white">
                                    <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300">{{$categorie->categorie}}</span>

                                </td>
                                <td class="px-4 py-3 font-roboto flex items-center justify-end">
