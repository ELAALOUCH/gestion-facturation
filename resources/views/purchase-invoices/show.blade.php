...
<nav class="flex px-10" aria-label="Breadcrumb">
    ...
    <li aria-current="page">
        ...
        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Voire facture d'achat</span>
        </div>
    </li>
    </ol>
</nav>
    <div  class="px-10 ">
            <div class="flex flex-col">
                <p class=" h-11 w-full pt-2.5 bg-blue-50 my-8 pl-2 font-roboto font-bold text-blue-950 border-l-4 border-blue-900">Le infos de facture :</p>
